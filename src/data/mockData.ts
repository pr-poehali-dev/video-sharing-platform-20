...
export const commentsMap: Record<string, Comment[]> = {
  v1: [
    { id: "cm1", author: "Алексей К.", avatar: "🧑‍💻", text: "Невероятная подборка! Особенно впечатлил гаджет под номером 3, уже заказал себе.", likes: 342, timestamp: "1 день назад", replies: [
      { id: "cm1r1", author: "TechVision", avatar: "🤖", text: "Спасибо! Рады, что понравилось. Скоро будет отдельный обзор на него!", likes: 89, timestamp: "23 часа назад" },
      { id: "cm1r2", author: "Марина С.", avatar: "👩", text: "А где его купить можно? Не нашла в магазинах.", likes: 15, timestamp: "20 часов назад" },
    ]},
    { id: "cm2", author: "Дмитрий Н.", avatar: "👨", text: "Каждый раз жду ваших обзоров, лучший контент по технологиям на платформе!", likes: 218, timestamp: "2 дня назад" },
    { id: "cm3", author: "Ольга В.", avatar: "👩‍🦰", text: "Подарила мужу на день рождения гаджет из вашего списка — он в восторге 🎉", likes: 156, timestamp: "1 день назад" },
    { id: "cm4", author: "Игорь П.", avatar: "🧔", text: "Половина этих гаджетов стоят целое состояние... Есть что-то бюджетное?", likes: 94, timestamp: "18 часов назад" },
  ],
  v2: [
    { id: "cm5", author: "Наталья М.", avatar: "👩‍🦱", text: "Кавказ — это просто магия. Была там прошлым летом, хочу ещё!", likes: 567, timestamp: "4 часа назад" },
    { id: "cm6", author: "Руслан Г.", avatar: "🧑", text: "Какой камерой снимаете? Картинка потрясающая!", likes: 234, timestamp: "3 часа назад", replies: [
      { id: "cm6r1", author: "Мир Путешествий", avatar: "🌍", text: "Sony A7IV + дрон DJI Mini 4 Pro. Спасибо!", likes: 78, timestamp: "2 часа назад" },
    ]},
    { id: "cm7", author: "Анна Д.", avatar: "👧", text: "Подскажите маршрут, пожалуйста! Хотим с семьёй поехать.", likes: 189, timestamp: "2 часа назад" },
  ],
  v3: [
    { id: "cm8", author: "Елена Р.", avatar: "👩‍🍳", text: "Приготовила по вашему рецепту — вся семья в восторге! Спасибо огромное!", likes: 891, timestamp: "6 дней назад", replies: [
      { id: "cm8r1", author: "ШефПовар", avatar: "👨‍🍳", text: "Очень рад! Попробуйте также добавить немного трюфельного масла — будет ещё вкуснее 😋", likes: 234, timestamp: "5 дней назад" },
    ]},
    { id: "cm9", author: "Максим Т.", avatar: "🧑‍🦲", text: "Наконец-то нормальный рецепт без 100 ненужных ингредиентов!", likes: 445, timestamp: "5 дней назад" },
    { id: "cm10", author: "Светлана К.", avatar: "👱‍♀️", text: "А можно заменить гуанчале на бекон? У нас не продаётся 😅", likes: 67, timestamp: "4 дня назад" },
  ],
};

Object.keys(commentsMap).forEach(() => {});
videos.forEach((v) => {
  if (!commentsMap[v.id]) {
    commentsMap[v.id] = [
      { id: `${v.id}-cm1`, author: "Пользователь", avatar: "😊", text: "Отличное видео! Очень понравилось, подписался на канал.", likes: Math.floor(Math.random() * 500), timestamp: "недавно" },
      { id: `${v.id}-cm2`, author: "Зритель", avatar: "👍", text: "Супер контент, продолжайте в том же духе!", likes: Math.floor(Math.random() * 300), timestamp: "недавно" },
    ];
  }
});

export default { videos, categories, channels, sidebarItems, sidebarSubscriptions, commentsMap };